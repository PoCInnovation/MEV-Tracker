# Contributing to MEV-Tracker

## Create an issue

- If you've encountered a bug, open a [Bug Report](https://github.com/PoCInnovation/MEV-Tracker/issues/new?assignees=&labels=&template=bug_report.md&title=).
- If you want Mev-Tracker to have a new fonctionality, open a [Feature Request](https://github.com/PoCInnovation/MEV-Tracker/issues/new?assignees=&labels=&template=feature_request.md&title=).

## Resolve an issue

Select an [issue](https://github.com/PoCInnovation/MEV-Tracker/issues) that you want to resolve.

The recommended workflow is to fork this repository and open pull requests from your fork.

### 1. Fork, clone & configure MEV-Tracker upstream
...
git clone git@github.com:PoCInnovation/MEV-Tracker.git

# Add your fork as a remove
git remote add <fork_name> https://github.com/$YOUR_GITHUB_USER/MEV-Tracker.git
```
...
# Create a new pull request from https://github.com/PoCInnovation/MEV-Tracker/pulls
```
